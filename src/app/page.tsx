  ...
  return (
    ...
    <div className="light h-[28vh]">
        <div className="max-w-[1440px] mx-auto relative">
            ...
            <div className="grid grid-cols-4 gap-x-9 w-full absolute mt-5">
              <div className="grid place-items-center bg-card border-t-Facebook border-t-4 rounded-md">
                ...
                <div className="flex items-center text-Lime-Green font-bold space-x-2  my-5">
                  <div>
              ...
              <div className="grid place-items-center bg-card border-t-YouTube border-t-4 rounded-md">
                ...
                <div className="flex items-center text-Bright-Red font-bold space-x-2  my-5">
                  <div>
