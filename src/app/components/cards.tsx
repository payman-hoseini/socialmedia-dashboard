...
export default function Cards({darkMode} : {darkMode : boolean}){
    return (
        <div className="my-14">
            <h2 className={`font-bold ${darkMode ? "text-bw-text" : "text-text" } md:text-3xl text-2xl`}>Overview - Today</h2>
            <div className="mt-7 grid md:grid-cols-4 md:gap-x-9 md:gap-y-7 gap-y-4">
                <div className="bg-card rounded-md px-8 pb-6 pt-8 hover:contrast-[.85] hover:cursor-pointer">
