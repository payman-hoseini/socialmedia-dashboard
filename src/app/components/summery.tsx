...
export default function Summery(){
    return (
        <div className="grid md:grid-cols-4 grid-cols-1 md:gap-x-9 gap-y-8 md:gap-y-0 w-full  mt-5">
            <div className="grid place-items-center bg-card border-t-Facebook border-t-4 rounded-md hover:contrast-[.85] hover:cursor-pointer">
            ...
            <div className="grid place-items-center bg-card border-t-Twitter border-t-4 rounded-md hover:contrast-[.85] hover:cursor-pointer">
                <div className="flex items-center space-x-2 my-8">
            ...
            <div className="bg-gradient-to-r from-Instagram_1 to-Instagram_2 rounded-md pt-[3.5px] hover:contrast-[.85] hover:cursor-pointer">
            ...
            <div className="grid place-items-center bg-card border-t-YouTube border-t-4 rounded-md hover:contrast-[.85] hover:cursor-pointer">
                <div className="flex items-center space-x-2 my-8">
